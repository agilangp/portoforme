...
const Home: NextPage = () => {
    return (
        <Layout>
            <div className="h-full flex items-center place-content-between py-5 gap-2">
                <div>
                    <p className="font-semibold text-gray-500 text-lg">
                        Hello, I am
                    </p>
                    <p className="uppercase font-bold text-4xl py-2">
                        Alwin <span className="text-orange-600">Gilang</span>{" "}
                        Permana
                    </p>
                ...
                <div className="rounded-full overflow-hidden border-8 border-orange-600">
                    <Image
