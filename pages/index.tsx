                ...
                <div className="w-full object-fill sm:col-span-3 flex flex-col place-content-between text-center sm:text-left">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap sm:gap-2 p-4 justify-center sm:justify-start">
                            ...
                            <IconLink href="https://web.facebook.com/al.gilang.p">
                                <svg
                            ...
                            <IconLink href="https://twitter.com/alwin_gilang">
                                <svg
                                    className="w-6 h-6 fill-current"
                                    role="img"
                                    xmlns="http://www.w3.org/2000/svg"
                            ...
                            <IconLink href="https://github.com/al-gilang-p">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    aria-hidden="true"
                                    role="img"
                            ...
                            <IconLink href="https://www.linkedin.com/in/alwin-gilang-permana-53674b170">
                                <svg
                                    className="w-6 h-6 fill-current"
                                    role="img"
                                    viewBox="0 0 256 256"
